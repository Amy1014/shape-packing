...
//_________________________________________________________
    ...
    protected:
        void set_halfedge_tex_vertex(Map::Halfedge* h, Map::TexVertex* tv) {
            if(!halfedge_tex_vertex_.is_bound()) {
                halfedge_tex_vertex_.bind(target(), "tex_vertex") ;
            }
            halfedge_tex_vertex_[h] = tv ;
        }
